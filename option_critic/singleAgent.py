...
class OptionCriticAgent(nn.Module):
    def __init__(self, in_features, num_actions, num_options):
        ...
        self.Q = nn.Linear(32, self.num_options)
        self.target_q = nn.Linear(32, self.num_options)
        self.policy = nn.Linear(32, self.num_actions * self.num_options)
        self.termination = nn.Linear(32, self.num_options)
